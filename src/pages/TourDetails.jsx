...
const TourDetails = () => {
  ...
  //fetch data from database through of api
  ...
  const submitHandler = e => {
    ...
    try {
      ...
      if (!res.ok) { return alert("review submitted") }
                          ...
                          <div className='review__item' key={id}>
                            ...
                            <div className='w-100'>
                              <div className='d-flex align-items-center justify-content-between'>
                                ...
                                <span className='d-flex align-items-center'>{reviews.rating} <i className='ri-star-s-fill'></i></span>
                              </div>
